...
for file_path in glob.glob(input_folder):
    ...
    RUN_temp(file_path,output_folder,'temperature_new.js',True)
    RUN_sal(file_path,output_folder,'salinity_new.js',True)
    RUN_wind(file_path,output_folder,'wind_new.js',True)
